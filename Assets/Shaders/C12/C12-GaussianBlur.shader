...
Shader "Custom/C12/GaussianBlur"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        v2f vertBlurVertical(appdata_img v)
        {
            ...
            o.uv[0] = uv;
            o.uv[1] = uv + float2(0, _MainTex_TexelSize.x * 1) * _BlurSize;
            o.uv[2] = uv - float2(0, _MainTex_TexelSize.x * 1) * _BlurSize;
            o.uv[3] = uv + float2(0, _MainTex_TexelSize.x * 2) * _BlurSize;
            o.uv[4] = uv - float2(0, _MainTex_TexelSize.x * 2) * _BlurSize;
